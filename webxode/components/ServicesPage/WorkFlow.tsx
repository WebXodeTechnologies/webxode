  ...
  return (
    <section className="py-20">
      <div className="flex flex-col justify-center mb-10">
        <h1 className="text-4xl text-purple text-center mb-2 font-montserrat">
          Scalable & Secure Products
        </h1>
        <p className="text-lg text-white text-center mb-5 text-wrap container max-w-4xl">
          Leverage our expert team to craft innovative solutions that align with
          your business goals. We ensure a seamless transition into the digital
          era, driving growth, scalability, and long-term success
        </p>
      </div>
        ...
        <div className="flex flex-col justify-center mt-5 md:mt-2">
          {datapoints.map((point) => (
            <div key={point.id} className="flex items-center mb-5">
              ...
              <div>
                <h2 className="text-xl text-white font-montserrat">
                  {point.title}
                </h2>
              </div>
            </div>
