...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-start mb-10 relative z-10 text-neutral-400">
        <div className="text-5xl">{icon}</div>
      </div>
      <div className="text-lg font-bold mb-2 relative z-10 px-10 ">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-300 bg-neutral-700 group-hover/feature:bg-blue-500 transition-all duration-200 origin-center" />
        <span className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-neutral-100">
          {title}
        </span>
      </div>
      <p className="text-sm text-neutral-300  relative z-10 px-10">
        {description}
      </p>
      {/* <button
