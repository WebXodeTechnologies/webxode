...
const Footer = () => {
  return (
    <footer className="py-20 text-white">
      ...
      {/* Divider */}
      <hr className="border-t-1 border-dashed border-neutral-300 shadow-2xl mb-6 mx-10" />
      ...
      <div className="flex flex-col md:flex-row justify-between items-center px-10">
        ...
        <div className="flex gap-4">
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <FaFacebook className="w-5 h-5 hover:text-purple-500 transition-colors" />
          </a>
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
            <FaTwitter className="w-5 h-5 hover:text-purple-500 transition-colors" />
          </a>
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <FaLinkedin className="w-5 h-5 hover:text-purple-500 transition-colors" />
          </a>
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <FaInstagram className="w-5 h-5 hover:text-purple-500 transition-colors" />
          </a>
        </div>
      </div>
    </footer>
